...
<br>
<br>
  <div class="mx-auto"style="width: 560px;color: #0275d8;">
...
<br>
    ...
    <form class="mx-auto" style="width:800px" method="post" action="Register">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          <label>Valeur</label>
          <input id="valeur" class="form-control" name="valeur">
        </div>
      </div>
